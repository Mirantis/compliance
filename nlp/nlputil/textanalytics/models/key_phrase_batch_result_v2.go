...
// KeyPhraseBatchResultV2 key phrase batch result v2
// swagger:model KeyPhraseBatchResultV2
...
func (m *KeyPhraseBatchResultV2) validateDocuments(formats strfmt.Registry) error {
...
func (m *KeyPhraseBatchResultV2) validateErrors(formats strfmt.Registry) error {
